...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <header id="kc-header" class="pf-v5-c-login__header">
      <div id="kc-header-wrapper" class="pf-v5-c-brand mymusic-brand">
        <img src="${url.resourcesPath}/img/mark.svg" alt="" class="mymusic-mark" width="28" height="28" />
        <span class="mymusic-brand-word">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</span>
      </div>
    </header>
