namespace MyMusic.Application.Tests.Features.Sammlung.Record.ResponseDtos.Builder;

public class RecordResponseBuilderTests
{
    private readonly RecordResponseBuilder _builder = new();
    ...
    public void Build_MitTracks_UebernimmtTracklisteUnveraendert()
    {
        // arrange
        var record = RecordEntity.Create(
            1, 1, 2, RecordFormat.Album, "Abbey Road", 1969, RecordCondition.Nm, null, Guid.NewGuid());
