...
public class UpdateGenreCommandValidatorTests
{
    ...
    {
        // arrange
        var command = new UpdateGenreCommand { Id = 1, Name = "Jazz", UserId = Guid.NewGuid() };
    ...
    {
        // arrange
        var command = new UpdateGenreCommand { Id = 1, Name = string.Empty, UserId = Guid.NewGuid() };
        ...
        Assert.Contains(result.Errors, error => error.PropertyName == nameof(UpdateGenreCommand.Name));
    }
    ...
    {
        // arrange
        var command = new UpdateGenreCommand { Id = 1, Name = name, UserId = Guid.NewGuid() };
